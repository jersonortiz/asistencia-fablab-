 ...
 */
@Entity
@Table(name = "visita_semillero")
@NamedQueries({
    @NamedQuery(name = "VisitaSemillero.findAll", query = "SELECT v FROM VisitaSemillero v"),
    @NamedQuery(name = "VisitaSemillero.findById", query = "SELECT v FROM VisitaSemillero v WHERE v.id = :id"),
    @NamedQuery(name = "VisitaSemillero.findByFecha", query = "SELECT v FROM VisitaSemillero v WHERE v.fecha = :fecha"),
    @NamedQuery(name = "VisitaSemillero.findByOtroPrograma", query = "SELECT v FROM VisitaSemillero v WHERE v.otroPrograma = :otroPrograma")})
public class VisitaSemillero implements Serializable {
    ...
    public VisitaSemillero() {
    }

    public VisitaSemillero(Integer id) {
        this.id = id;
    }

    public VisitaSemillero(Integer id, Date fecha) {
        this.id = id;
        this.fecha = fecha;
    }
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof VisitaSemillero)) {
            return false;
        }
        VisitaSemillero other = (VisitaSemillero) object;
    ...
    public String toString() {
        return "com.fablab.ufps.edu.co.asistencia.entity.VisitaSemillero[ id=" + id + " ]";
    }
